...
export default function Home() {
  ...
  return (
    <>
      <h1 className="text-4xl min-[350px]:text-5xl min-[550px]:text-6xl lg:text-7xl xl:text-8xl text-center tracking-tight font-bold min-[300px]:font-black bg-clip-text bg-gradient-to-br from-gray-500 to-gray-950 to-50% text-transparent mt-28 mb-10 min-[420px]:mb-14 leading-3 antialiased">
        Make {"URL's"}
